...
}; // type is 'success or 'error , afterbegin: l'alert va apparaitre ds le body mais en tt debut
...
var stripe = Stripe('pk_test_YMU1TqH2tyLt499ke8K1O3SL00IsYK7GAo');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); // pour avoir differents form de data y compris les photo
